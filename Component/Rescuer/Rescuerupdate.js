    ...
    <ScrollView contentContainerStyle={{flexGrow: 1, backgroundColor: 'white'}}>
      ...
      >
        ...
        <View style={{paddingHorizontal: 20}}>
          <View style={{ width: '100%', height: 820, backgroundColor: 'white', top: -50, borderRadius: 30, marginBottom: -30, elevation: 5, padding: 20, gap: 20 }}>
         <Text style={{ textAlign: 'center', color: '#093624', fontSize: 25, margin: 20, fontWeight: 'bold' }}>{t('Update Profile')}</Text>
