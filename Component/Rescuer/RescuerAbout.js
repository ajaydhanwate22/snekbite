...
function RescuerAboutscreen({navigation}) {
      ...
      <ScrollView style={{backgroundColor:'white'}}>
        <View style={{backgroundColor: 'white'}}>
          ...
          <View>
            ...
            <Text style={{textAlign: 'center', color: '#093624', fontSize: 12, margin:10,  }}>
              Addressing the Snakebite Crisis in India World For Nature is
              committed to tackling the critical issue of snakebite envenoming
              in India. We recognize the devastating impact it has on
              communities, causing fatalities and disabilities.
            </Text>
...
export default RescuerAboutscreen;
