  ...
  <ScrollView style={{ backgroundColor: 'white' }}>
      <ImageBackground
        source={require('../Assets/background.png')} style={{flex: 1,alignItems: 'center',justifyContent: 'center',
          overflow: 'hidden',height: 180,borderBottomLeftRadius: 40,borderBottomRightRadius: 40,}}>
        ...
        <Image source={require('../Assets/logo.png')}style={{resizeMode: 'contain', height: 100, width: 100, top:-20}}/>
      </ImageBackground>
      <View style={{paddingHorizontal:20}}>
        <View style={{ width: '100%',height: 550,backgroundColor: 'white',top: -50,borderRadius: 30,marginBottom: -30,elevation: 5,padding:20,gap:20}}>
          <Text style={{ textAlign: 'center',color: '#093624',fontSize: 25,fontWeight: 'bold',margin:20}}>
             Form</Text>

             <TouchableOpacity onPress={handleImagePick}>
            <View style={{width: '35%', height: 90, backgroundColor: '#FFFFFF', borderRadius: 10, elevation: 10, borderColor: '#000000', borderWidth: 1, marginBottom: 20, alignSelf: "center"}} >
              {image ? (
          ...
          <TextInput style={{ flexDirection: 'row', alignItems: 'center',borderWidth: 1,borderColor: '#093624',
            ...
            placeholder="Current Location"  placeholderTextColor="#093624" value={CurrentLocation} onChangeText={setCurrentLocation}/>

          <TextInput style={{ flexDirection: 'row', alignItems: 'center',borderWidth: 1,borderColor: '#093624',
              borderRadius: 10,paddingLeft: 10,gap: 20,width: '100%',height: 55,}}
            placeholder="Manual Location"  placeholderTextColor="#093624" value={Manuallocation} onChangeText={setManualLocation}/>

          <TextInput style={{ flexDirection: 'row', alignItems: 'center',borderWidth: 1,borderColor: '#093624',
              borderRadius: 10,paddingLeft: 10,gap: 20,width: '100%',height: 55,}}
            placeholder="Description"  placeholderTextColor="#093624" value={Description} onChangeText={setDescription}/>
